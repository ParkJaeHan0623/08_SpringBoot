...
public class RestHelper {
    ...
    public Map<String, Object> sendJson(int status, String message, Map<String, Object> data, Exception error) {
        ...
        // CORS 허용 */
        // (보안에 좋지 않기 때문에 이 옵션을 허용할 경우 인증키등의 보안장치가 필요함)
        // 여기서는 실습을 위해 허용함
     ...
     * @param error - 에러 이름....인데 현재 파라미터에 입력되지 않았네...
     * @return - Map<String, Object>
     */
     ...
     * 400 에러 이외의 모든 경우에 사용한다. 주로 DB 연동등의 처리에서 발생한 에러를 처리한다.
     * 
     * @param message - 에러 메시지
     * 
     * @return - Map<String, Object>
