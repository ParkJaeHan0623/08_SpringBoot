...
class UtilHelper {
  ...
  async alert(title, text, icon, confirmButtonText, confirmButtonColor) {
    if (Swal !== undefined) {
      ...
      return await Swal.fire({
        ...
        confirmButtonText: confirmButtonText, // 확인 표시 문구
        confirmButtonColor: confirmButtonColor, // 확인 버튼 색상
  ...
  async alertPrimary(title, text = undefined) {
    return await this.alert(title, text, "info", "확인", this.colorMap.primay);
  }
  ...
  async confirm(title, text,confirmButtonText, confirmButtonColor, cancelButtonText, cancelButtonColor) {
    if (Swal !== undefined) {
      return await Swal.fire({
        ...
        cancelButtonText: cancelButtonText, // 취소 표시 문구
        cancelButtonColor: cancelButtonColor, // 취소 버튼 색상
      });
    } else {
      return confirm(text);
    }
  ...
  async confirmPrimary(title, text ,confirmButtonText = "확인", cancelButtonText = "취소") {
    return await this.confirm(title,text,confirmButtonText,this.colorMap.primay,cancelButtonText,this.colorMap.light);
  }
